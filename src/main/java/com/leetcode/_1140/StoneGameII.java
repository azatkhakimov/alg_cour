package main.java.com.leetcode._1140;
...
public class StoneGameII {
    ...
    public static void main(String[] args) {
        var s = new StoneGameII();
        System.out.println(s.stoneGameII(new int[]{2,7,9,4,4}));//Output: 10
        System.out.println(s.stoneGameII(new int[]{1,2,3,4,5,100}));//Output: 104
    }
}
