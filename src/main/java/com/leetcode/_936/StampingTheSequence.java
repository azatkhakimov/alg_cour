package main.java.com.leetcode._936;
...
public class StampingTheSequence {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(stampingTheSequence.movesToStamp("abc", "ababc")));//Output: [0,2]
        System.out.println(Arrays.toString(stampingTheSequence.movesToStamp("abca", "aabcaca")));//Output: [3,0,1]
    }
}
