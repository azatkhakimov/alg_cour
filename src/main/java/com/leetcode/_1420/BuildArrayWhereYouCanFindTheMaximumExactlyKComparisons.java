package main.java.com.leetcode._1420;
...
public class BuildArrayWhereYouCanFindTheMaximumExactlyKComparisons {
    ...
    public static void main(String[] args) {
        var b = new BuildArrayWhereYouCanFindTheMaximumExactlyKComparisons();
        System.out.println(b.numOfArrays(2,3,1));//Output: 6
        System.out.println(b.numOfArrays(5,2,3));//Output: 0
        System.out.println(b.numOfArrays(9,1,1));//Output: 1
    }
}
